        ...
        ?>
									...
									<form id="kapida_kredi_karti_ile_odeme_formu" method="post"
										...
										<div class="form-group">
											<label for="" class="control-label"><?php echo $lng_ad_soyad?></label> <input
												type="text" class="form-control" id="ad_soyad"
												value="<?php echo $send?>" name="ad_soyad" />
										</div>
										...
										<div class="form-group">
											...
											<textarea style="height: 100px;" name="message" id="message"
												class="form-control  " maxlength="160"> <?php echo $message?> </textarea>
										</div>
